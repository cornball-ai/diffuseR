...
ddim_scheduler_step <- function(model_output, timestep, sample, schedule,
                                eta = 0, use_clipped_model_output = FALSE,
                                thresholding = FALSE, generator = NULL,
                                variance_noise = NULL, clip_sample = FALSE,
...
#'
#' @export
scheduler_add_noise <- function(original_latents, noise, timestep,
                                scheduler_obj) {
